...
/** DA WAE Visualizes life expectancy in different countries.
 ...
 * mapping.
 */
public class GG_LifeExpectancy extends PApplet {
	...
	private Map<String, Float> loadLifeExpectancyFromCSV(String filename){
		...
		// A HashMap object is created that implements Map.
		Map<String, Float> lifeExpMap = new HashMap<String, Float>();

		// Array of Strings is declared to contain Strings from CSV File.
		String[] rows = loadStrings(filename);

		// Enhanced for. We iterate over each element at "rows" and element will be referred to as "row"
