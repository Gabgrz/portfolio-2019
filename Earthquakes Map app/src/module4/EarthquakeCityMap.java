...
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {		
		...
		if (offline) {
		    map = new UnfoldingMap(this, 250, 50, 650, 600, new MBTilesMapProvider(mbTilesString));
		    earthquakesURL = "2.5_week.atom";  // The same feed, but saved August 7, 2015
		}
		else {
			map = new UnfoldingMap(this, 300, 50, 650, 600, new Microsoft.AerialProvider());
	    ...
	    for(PointFeature feature : earthquakes) {
		  //check if LandQuake
		  if(isLand(feature)) {
			// System.out.println("Is Land? "+isLand(feature));
		...
		//        String country = (String)m.getProperty("country");
			...
			for (Marker m : quakeMarkers) {
				...
				if (em.isOnLand){
					...
					System.out.println(em.getProperty("country").toString());
			...
			System.out.println("Number of earthquakes in oceans: "+countt);
			System.out.println("Number of earthquakes in China: "+countChina);
